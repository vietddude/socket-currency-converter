...
class RealTimeCurrencyConverter:
    def __init__(self, url_data):
        self.data = requests.get(url_data).json()
...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        ...
        # Label
        self.intro_label = Label(self, text='Welcome to Real Time Currency Convertor', bg='dodgerblue2', relief=tk.RAISED,
                                 borderwidth=3)
        ...
        cusFont = ("Courier", 12, "bold")
        self.option_add('*TCombobox*Listbox.font', cusFont)
        self.from_currency_dropdown = ttk.Combobox(self, textvariable=self.from_currency_variable,
                                                   values=list(self.currency_converter.currencies.keys()), font=cusFont,
